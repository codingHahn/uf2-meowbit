...
export COMMON_SRCS	 = bl.c test.bmp.c empty.bmp.c ghostfat.c dmesg.c screen.c images.c settings.c hf2.c support.c util.c is31fl3731.c i2chelper.c matrix_text.c scrollbit.c alphabet.c pca9685.c servo.c leg.c
...
FL_OBJS = $(addprefix $(BUILD_DIR)/, bl.o test.bmp.o empty.bmp.o main-flasher.o util.o dmesg.o screen.o images.o settings.o is31fl3731.o i2chelper.o matrix_text.o scrollbit.o alphabet.o support.o pca9685.o servo.o leg.o)
